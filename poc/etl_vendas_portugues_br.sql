SELECT
    ...
    TAXA AS taxa -- Rate
into etl_solbi_sales
FROM BI_FAT_FATO_VENDAS
WHERE TES_GERA_DUPLICATA = 'S'
AND VENDA_INTERCOMPANY <> 'S'


select * from etl_solbi_sales
order by filial_que_vendeu_o_produto,data_venda_do_produto,tipo_movimento_venda_ou_devolucao_de_produto